...
- `f:\Prime\.cursor\skills\ui-tailwind-ui-kit\SKILL.md` — for interactive components requiring Headless UI
- `f:\Prime\.cursor\skills\ui-accessibility\SKILL.md` — for accessibility requirements
- `f:\Prime\UI_Command\UI_KNOWLEDGE.md` — §4 common mistakes, §5 file conventions
