...
- `f:\Prime\UI_Command\UI_KNOWLEDGE.md` — §1.2 for full UI Kit component map
- `f:\Prime\.cursor\skills\ui-accessibility\SKILL.md` — for deep accessibility requirements
- `f:\Prime\.cursor\skills\ui-component-builder\SKILL.md` — for non-interactive component patterns
