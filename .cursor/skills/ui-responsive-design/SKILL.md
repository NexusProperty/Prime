...
- `f:\Prime\UI_Command\UI_KNOWLEDGE.md` — §1 for Tailwind Plus responsive patterns
- `f:\Prime\.cursor\skills\ui-accessibility\SKILL.md` — touch target requirements
- `f:\Prime\UI_Command\rules\ui-builder.mdc` — §2 responsive rules
