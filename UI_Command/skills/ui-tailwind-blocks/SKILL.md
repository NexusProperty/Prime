...
- `f:\PromptAI\UI_Command\UI_KNOWLEDGE.md` — §1.3 for full block category reference
- `f:\PromptAI\UI_Command\skills\ui-tailwind-templates\SKILL.md` — for assembling blocks into pages
- `f:\PromptAI\UI_Command\skills\ui-responsive-design\SKILL.md` — for responsive verification
