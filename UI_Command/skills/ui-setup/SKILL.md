...
- Write access to `f:\PromptAI\UI_Command\` for saving `project-config.json`
...
Write the following file to `f:\PromptAI\UI_Command\project-config.json`:
...
**Config saved to:** `f:\PromptAI\UI_Command\project-config.json`
...
- [ ] `project-config.json` exists at `f:\PromptAI\UI_Command\project-config.json`
...
- `f:\PromptAI\UI_Command\UI_KNOWLEDGE.md` — §2 for the full config schema
- `f:\PromptAI\UI_Command\skills\ui-tailwind-templates\SKILL.md` — for template selection detail
