...
- `f:\PromptAI\UI_Command\UI_KNOWLEDGE.md` — §1.1 for template characteristics
- `f:\PromptAI\UI_Command\skills\ui-tailwind-blocks\SKILL.md` — for block-level detail
- `f:\PromptAI\UI_Command\skills\ui-component-builder\SKILL.md` — for shared UI components
